    ...
    <div className=" w-screen overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className=" mt-14 flex md:flex-row flex-col justify-center w-full gap-8">
        <div className=" flex flex-col items-center">
          <div 
            className=" mb-6 z-10 group h-[23rem] relative rounded overflow-hidden shadow-lg w-[18rem] lg:w-[30rem] md:w-[20rem] sm:w-[20rem]"
            >
            <img src='' />
        ...
        <div className=" flex flex-col items-center">
          <div className=" mb-6 z-10 group h-[23rem] relative rounded overflow-hidden shadow-lg w-[18rem] lg:w-[30rem] md:w-[20rem] sm:w-[20rem]">
            <img src='' />
            <div className="px-6 z-10 absolute bg-white bg-opacity-30 w-full h-full transform duration-500 inset-y-[85%] group-hover:-inset-y-[0%] md:group-hover:-inset-y-[-30%] py-4">
